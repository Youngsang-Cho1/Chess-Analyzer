...
"""
        ...
        self.season_template = PromptTemplate(
            ...
            template="""You are a world-class chess coach. You are analyzing the recent performance of your student, {username} (Last {total_games} games).
...
Format the response as a mini coaching letter. Keep it under 6 sentences.
"""
        )
